...
--cleanTargets --loss_fn l2 --batch_size 4 --calcStats --phantomNoiseLevel 45 --sampMult 1 --randomOrder \
--trainPhantomFile ./HRPhantomData/SheppLoganPhan.mat --valPhantomFile ./HRPhantomData/YuYeWangPhan.mat --numEpochs 150 --splitsToTrain 1

#Noisy Targets
python trainOOP_CL.py --dataType phantom --saveDir ../results/phantom \
--loss_fn l2 --batch_size 4 --calcStats --phantomNoiseLevel 45 --sampMult 1 --randomOrder \
--trainPhantomFile ./HRPhantomData/SheppLoganPhan.mat --valPhantomFile ./HRPhantomData/YuYeWangPhan.mat --numEpochs 150 --splitsToTrain 1

#Next Targets (Nyquist)
python trainOOP_CL.py --dataType phantom --saveDir ../results/phantom --nextImFlag \
--loss_fn l1 --batch_size 4 --calcStats --phantomNoiseLevel 45 --sampMult 0.5 --randomOrder \
--trainPhantomFile ./HRPhantomData/SheppLoganPhan.mat --valPhantomFile ./HRPhantomData/YuYeWangPhan.mat --numEpochs 150 --splitsToTrain 1 --startSplit 0

#Next Targets (Nyquist/2)
python trainOOP_CL.py --dataType phantom --saveDir ../results/phantom --nextImFlag \
--loss_fn l2 --batch_size 4 --calcStats --phantomNoiseLevel 45 --sampMult 2 --randomOrder \
--trainPhantomFile ./HRPhantomData/SheppLoganPhan.mat --valPhantomFile ./HRPhantomData/YuYeWangPhan.mat --numEpochs 150 --splitsToTrain 1

#Next Targets (Nyquist/3)
python trainOOP_CL.py --dataType phantom --saveDir ../results/phantom --nextImFlag \
--loss_fn l2 --batch_size 4 --calcStats --phantomNoiseLevel 45 --sampMult 3 --randomOrder \
--trainPhantomFile ./HRPhantomData/SheppLoganPhan.mat --valPhantomFile ./HRPhantomData/YuYeWangPhan.mat --numEpochs 150 --splitsToTrain 1

#Next Targets (Nyquist/4)
python trainOOP_CL.py --dataType phantom --saveDir ../results/phantom --nextImFlag \
--loss_fn l2 --batch_size 4 --calcStats --phantomNoiseLevel 45 --sampMult 4 --randomOrder\
--trainPhantomFile ./HRPhantomData/SheppLoganPhan.mat --valPhantomFile ./HRPhantomData/YuYeWangPhan.mat --numEpochs 150 --splitsToTrain 1

#line2line
python trainOOP_CL.py --dataType phantom --saveDir ../results/phantom --nextImFlag \
--loss_fn l2 --batch_size 4 --calcStats --phantomNoiseLevel 45 --sampMult 1 --singleImage --randomOrder\
--trainPhantomFile ./HRPhantomData/SheppLoganPhan.mat --valPhantomFile ./HRPhantomData/YuYeWangPhan.mat --numEpochs 150 --splitsToTrain 1

#noise2void
python trainOOP_CL.py --dataType phantom --saveDir ../results/phantom --nextImFlag \
--loss_fn l2 --batch_size 4 --calcStats --phantomNoiseLevel 45 --sampMult 1 --singleImage --noise2VoidFlag --randomOrder\
--trainPhantomFile ./HRPhantomData/SheppLoganPhan.mat --valPhantomFile ./HRPhantomData/YuYeWangPhan.mat --numEpochs 150 --splitsToTrain 1
