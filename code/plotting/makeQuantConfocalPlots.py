...
if __name__ == '__main__':
    ...
    sns.swarmplot(x='Method',y=' PSNR',data=volDF,ax=ax[0],color=".25",size=5,order=['Supervised','noise2Nyquist','noise2void','neighbor2neighbor'])
    ...
    sns.swarmplot(x='Method',y=' SSIM',data=volDF,ax=ax[1],color=".25",size=5,order=['Supervised','noise2Nyquist','noise2void','neighbor2neighbor'])
